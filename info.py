...
auth_channel = environ.get('AUTH_CHANNEL', '-1003418036732')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003407478240').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '8186554166')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-5060352218')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1003418036732').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1003215809453').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.postimg.cc/wMHwdbyd/IMG-20251128-024008-102.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '01875312198')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "akash198")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'akash0187')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1003407478240'))  # Log channel id (make sure bot is admin)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+0xuRHqG0DcI0OGM1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+0xuRHqG0DcI0OGM1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/SVFADMINBOT')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+GWSpqMMd4fg2ZjJl')
OWNERID = int(os.environ.get('OWNERID', '8186554166'))  # Replace with the actual admin ID
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003371084874')).split()]
